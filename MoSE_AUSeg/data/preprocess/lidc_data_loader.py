...
import sys
import os
sys.path.append(os.path.abspath("C:/Users/Seo/Downloads/MoSE-AUSeg-main"))
...
def prepare_data(input_file, output_file):
    ...
    print(f"Number of train IDs: {len(split_ids['train'])}")
    print(f"Number of val IDs: {len(split_ids['val'])}")
    print(f"Number of test IDs: {len(split_ids['test'])}")
    ...
    for tt in ['test', 'train', 'val']:
        ...
        groups[tt].create_dataset('images', data=np.asarray(images[tt], dtype=np.float64))
...
def load_and_maybe_process_data(input_file,
    ...
    '''
    print('**** load_and_maybe_process_data')
...
if __name__ == '__main__':
    ...
    data_root = 'C:/Users/Seo/Downloads/MoSE-AUSeg-main/data/data_lidc.pickle'
    # preproc_folder = '../data/preproc'
    preproc_folder = 'C:/Users/Seo/Downloads/MoSE-AUSeg-main/data/preproc'
    # npy_dir = '../data/lidc_npy'
    npy_dir = 'C:/Users/Seo/Downloads/MoSE-AUSeg-main/data/lidc_npy'

    save_npy(load_and_maybe_process_data(data_root, preproc_folder, force_overwrite=True), npy_dir)
